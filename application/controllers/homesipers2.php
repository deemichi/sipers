...
class homesipers2 extends AUTH_Controller {
	...
	public function index() {
		...
		$data['jml_pejabat']	= $this->M_pejabat->total_rows();
		$data['jml_usulanrakor']	= $this->M_usulanrakor->total_rows();
		...
		$this->template->views('homesipers2', $data);
	}
}
