...
class lihatpejabat extends AUTH_Controller {
	...
	public function index() {
		...
		$data['modal_tambah_pejabat2'] = show_my_modal('modals/modal_tambah_pejabat2', 'tambah-pejabat', $data);

		$this->template->views('pejabat/vhomepejabat', $data);
	}
	...
	public function update() {
		...
		echo show_my_modal('modals/modal_update_pejabat2', 'update-pejabat', $data);
	}
