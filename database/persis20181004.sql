...
--
-- Host: 127.0.0.1
-- Generation Time: 04 Okt 2018 pada 07.13
...
CREATE TABLE `d_pejabat` (
  ...
  `d_instansi` varchar(30) NOT NULL,
...
(1, 'Abduh', 'Sekretariat Kabinet', 2, '2018-10-04 09:21:29'),
(4, 'Agung', 'Kementerian Pariwisata', 0, '2018-10-03 23:31:39'),
(5, 'Agung Hercules', 'Kementerian Kelautan', 0, '2018-10-04 04:29:58'),
...
--
ALTER TABLE `d_pejabat`
  MODIFY `d_kdpejabat` int(7) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
--
...
--
ALTER TABLE `f_usulan`
  MODIFY `f_kdusulan` int(7) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
--
